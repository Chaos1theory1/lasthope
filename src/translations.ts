...
export const i18n = {
  en: {
    ...
    aboutTeamDesc: "Discover the passionate professionals behind Mycelium Tech Digital Tunisia.",
    ...
    allRightsReserved: "Tunisian Mycelium Tech Digital. Registered under Tunisia RNE. All Rights Reserved.",
  ...
  fr: {
    ...
    aboutTeamDesc: "Découvrez les professionnels passionnés derrière Mycelium Tech Digital Tunisia.",
    ...
    allRightsReserved: "Tunisian Mycelium Tech Digital. Enregistré sous RNE Tunisien. Tous droits réservés.",
  ...
  ar: {
    ...
    aboutTeamDesc: "اكتشف العلماء والمهندسين الشغوفين وراء شركة ميسليوم تك ديجيتال تونس.",
